    ...
    <>
      ...
      <td className="px-4 py-3" colSpan={2}>
        <form action={onUpdate} className="flex items-center gap-2">
          ...
          <button type="submit" disabled={isPending} className="rounded bg-blue-600 px-3 py-1 text-xs font-semibold text-white hover:bg-blue-700 disabled:opacity-50">Save</button>
